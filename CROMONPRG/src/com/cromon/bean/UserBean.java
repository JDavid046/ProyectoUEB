...
public class UserBean {
	...
	{
		String pagina = "";
		anteriorEmail = usuario.getEmailAddress();
		UserDAO dao = new UserDAOImpl();
		User user = dao.getUserEmail(anteriorEmail);
	...
	public String getAnteriorEmail() {
		return anteriorEmail;
	}


	public void setAnteriorEmail(String anteriorEmail) {
		this.anteriorEmail = anteriorEmail;
	}
}
